...
import numpy as np
import random
from app.transformer import Transformer, CustomSchedule
from app.utils import masked_loss, masked_accuracy

VOCAB_SIZE = 15800
MAX_LENGTH = 100
EMBED_SIZE = 128

tokenizer = tf.saved_model.load("app/sub_word_tokenizer")
...
with open("app/vocab.txt", 'r') as file:
    for line in file:
